...
pub struct Validator<'a> {
    pub node_wallet: WalletAccount<'a>,
...
impl<'a> Validator<'a> {
    pub fn new(message: Message, wallet: WalletAccount<'a>, account_state: AccountState<'a>) -> Option<Validator<'a>> {
